...
public class Character : MonoBehaviour, IListener, ICanTakeDamage
{
    ...
    //ICanTakeDamage
    public virtual void TakeDamage(float damage, Vector2 force, Vector2 hitPoint, GameObject instigator, BODYPART bodyPart = BODYPART.NONE, WeaponEffect weaponEffect = null, WEAPON_EFFECT forceEffect = WEAPON_EFFECT.NORMAL) { }
